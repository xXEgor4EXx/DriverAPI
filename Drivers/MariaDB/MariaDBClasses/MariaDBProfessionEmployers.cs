...
class MariaDBProfessionEmployers : IDBProfessionEmployers
{
    ...
    public void Put(int id, ProfessionEmployers item)
    {
        ...
        var parameters = new List<MySqlParameter>
        {
            new MySqlParameter("@ProfessionEmployerID", item.ProfessionEmployerID),
    ...
    {
        string query = "INSERT INTO ProfessionEmployers (ProfessionEmployerID, EmployeeID, ProfessionID, Name, DateOfStart, DateOfEnd) VALUES (@ProfessionEmployerID, @EmployeeID, @ProfessionID, @Name, @DateOfStart, @DateOfEnd)";
