...
class DBWorks : IDBWorks
{
    ...
    {
        string query = "INSERT INTO Works (EmployeeID, OperationID, WorkDate, Quantity, RejectedQuantity) VALUES (@EmployeeID, @OperationID, @WorkDate, @Quantity, @RejectedQuantity)";
